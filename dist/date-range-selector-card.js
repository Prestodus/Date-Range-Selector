          ...
          <div class="custom-range-pickers">
            <div class="picker-group">
              <ha-date-input
                ...
                .min=${"string"==typeof this.config.min_date?this.config.min_date:""}
        ...
        `:l?Y`
          <div class="custom-range-pickers">
            <div class="picker-group">
              ...
              <button class="dialog-input" @click=${this._openStartDateDialog} ?disabled=${this.isUpdating}>
                ${we(this.currentStartDate,"yyyy-MM-dd")}
              </button>
            </div>
            <div class="picker-group">
              <label>End Date</label>
              <button class="dialog-input" @click=${this._openEndDateDialog} ?disabled=${this.isUpdating}>
                ${we(this.currentEndDate,"yyyy-MM-dd")}
              </button>
            </div>
          </div>
        `:Y`
